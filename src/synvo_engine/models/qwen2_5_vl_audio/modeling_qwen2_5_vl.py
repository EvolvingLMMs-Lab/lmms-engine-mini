...
class Qwen2_5_VLRotaryEmbedding(nn.Module):
    def __init__(self, config: KinoQwen2_5_VLConfig, device=None):
        super().__init__()
...
class Qwen2_5_VLAttention(nn.Module):
    ...
    def __init__(self, config: KinoQwen2_5_VLConfig, layer_idx: Optional[int] = None):
        super().__init__()
        self.config = config
...
class KinoQwen2_5_VLForConditionalGeneration(
