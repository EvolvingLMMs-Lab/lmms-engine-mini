...
class Qwen2VLAudioForConditionalGeneration(
    ...
    def forward(
        ...
        if audio_features is not None:
            ...
            audio_attention_mask = audio_attention_mask.to(target_device)
        ...
        if inputs_embeds is None:
            ...
            if pixel_values is not None:
                ...
                n_image_tokens = (
                    (input_ids == self.config.qwen_vl_config.image_token_id)
                    .sum()
                    .item()
                )
            ...
            if pixel_values_videos is not None:
                ...
                n_video_tokens = (
                    (input_ids == self.config.qwen_vl_config.video_token_id)
                    .sum()
                    .item()
                )
        ...
        if labels is not None:
            ...
            shift_logits = shift_logits.view(-1, self.config.qwen_vl_config.vocab_size)
        ...
        return Qwen2VLAudioCausalLMOutputWithPast(
            loss=loss,
            logits=logits,
    ...
    def get_rope_index(
        ...
        """
        spatial_merge_size = self.config.qwen_vl_config.vision_config.spatial_merge_size
        image_token_id = self.config.qwen_vl_config.image_token_id
        video_token_id = self.config.qwen_vl_config.video_token_id
        vision_start_token_id = self.config.qwen_vl_config.vision_start_token_id
